...
import kitchenBrigadeTeam from "@/assets/kitchen-brigade-team.png";
...
const LandingPage = () => {
  ...
  return <div className="min-h-screen bg-[#F8F7F5]">
        ...
        <div className="flex items-center justify-center px-6 py-16 lg:px-16 lg:py-24">
          <div className="max-w-xl text-center">
            ...
            <h1 className="font-['Playfair_Display'] text-[32px] md:text-[34px] font-semibold text-[#2C2C2C] leading-tight mb-6">
              Finally, Culinary Expertise You Can Trust
            </h1>
            <p className="font-['Inter'] text-[16px] md:text-[18px] text-[#6B6B6B] leading-relaxed mb-8">
              Your personal kitchen brigade: Executive Chef, Sous Chef, and seven specialists who don't just build recipes—they guide you through every step, answer every question, and help when things go wrong.
            </p>
      ...
      {/* Meet Your Kitchen Brigade Section */}
      <section className="py-16 md:py-24 px-6 bg-[#F8F7F5]">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-['Playfair_Display'] text-[18px] md:text-[20px] font-semibold text-[#2C2C2C] text-center mb-12">
            Meet Your Kitchen Brigade
          </h2>
          
          {/* Team Photo */}
          <div className="mb-12">
            <img 
              src={kitchenBrigadeTeam} 
              alt="Kitchen Brigade - Professional culinary team" 
              className="rounded-xl shadow-refined-md w-full max-w-5xl mx-auto"
            />
          </div>

          {/* Body Copy */}
          <div className="max-w-3xl mx-auto text-center">
            <p className="font-['Inter'] text-[17px] text-[#2C2C2C] leading-[1.7] mb-6">
              Your recipes aren't generated by generic AI. They're built by culinary specialists—each a master of their craft—working together like a professional kitchen brigade.
            </p>
            <p className="font-['Inter'] text-[17px] text-[#2C2C2C] leading-[1.7]">
              When things go wrong, they troubleshoot with you. When you need to adapt, they guide you. Professional expertise that actually has your back.
            </p>
          </div>
        </div>
      </section>
