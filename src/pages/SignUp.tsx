  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: 'Welcome to Culinary Advisor. You are now logged in.',
      });
      navigate('/chat');
    }
  };
    ...
    <div className="min-h-screen bg-culinary-cream flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-serif text-culinary-charcoal mb-2">Create Your Account</h1>
          <p className="text-culinary-charcoal/70">Begin your culinary journey</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-refined p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-culinary-charcoal/60">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-culinary-charcoal/70">
              ...
              <Link to="/login" className="text-culinary-accent hover:underline font-medium">
                Log In
              </Link>
            </p>
          </div>
